...
#    parse input arguments for analysis 
    ...
    parser.add_argument("-max_file", type=int, help="number of files to analyze",
                        default=1,dest='max_file')
    parser.add_argument("-max_anal", type=int, help="waveforms to be analyze",
                        default=100,dest='max_anal')
    ...
    print '  number of files                ',ar.max_file
    print '  Number of waveforms            ',ar.max_anal
     
    return ar.an_fil, ar.max_file, ar.max_anal
...
(an_fil, max_file, max_anal) = PMT_anal()
